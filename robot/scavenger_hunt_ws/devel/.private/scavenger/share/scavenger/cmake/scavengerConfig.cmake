...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'scavenger' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bwilab/scavenger_hunt/robot/scavenger_hunt_ws/src/scavenger/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bwilab/scavenger_hunt/robot/scavenger_hunt_ws/devel/.private/scavenger/lib;/home/bwilab/scavenger_hunt/robot/scavenger_hunt_ws/devel/lib;/home/bwilab/catkin_ws/devel/lib;/home/bwilab/prism_ws2/devel/lib;/opt/ros/kinetic/lib)
